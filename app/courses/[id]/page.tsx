...
const reviews = [
  ...
  },
  {
    ...
    comment: "Loved the course, it had been a while since I had experimented with watercolors and now I will.",
  },
  {
    id: 3,
    name: "Zhirkov",
...
export default async function CourseDetailPage({ params }: PageProps) {
  ...
  try {
    ...
    if (!courseResult) throw new Error("Course not found");
            ...
            <div className="sticky top-4 space-y-6">
              <div className="bg-card rounded-lg p-6 shadow-sm">
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center gap-3">📚 {courseData.chapters?.length || 0} Sections</div>
                  <div className="flex items-center gap-3">
                    📝 {courseData.chapters?.reduce((total, chapter) => total + chapter.lessons.length, 0) || 0} Lectures
                  </div>
